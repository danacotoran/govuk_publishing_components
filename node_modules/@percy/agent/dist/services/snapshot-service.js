...
class SnapshotService extends percy_client_service_1.default {
    ...
    create(name, resources, options = {}, clientInfo = null, environmentInfo = null) {
        const snapshotCreationPromise = this.percyClient.createSnapshot(this.buildId, resources, Object.assign(Object.assign({ name }, options), { minimumHeight: options.minHeight, clientInfo, environmentInfo })).then(async (response) => {
